...
class bag_listener:
    ...
    def __init__(self):
        ...
        self.sub = rospy.Subscriber("gps_info", Gprmc, self.callback)
    ...
    def callback(self, gps_data):
        ...
        speed_knots = gps_data.speed
        track_angle_deg = gps_data.track
        print("\n")
        ...
        LAT_START = 37.4052698333
        LON_START = -122.0832876667

...
# Steering parameters
PHYSICAL_MAX_STEERING_ANGLE_RAD = 0.52 # Max steering angle achievable by wheels (average left and right)
EFFECTIVE_MAX_STEERING_ANGLE_RAD_V1 = 0.30 # _Effective_ steering angle achievable by wheels (average left and right)

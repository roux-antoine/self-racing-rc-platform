...
def model_v2(radius, current_velocity):
    ...
    if current_velocity == 0:
        ...
        coeff = 1 / (
            coeff_region_2
            + (current_velocity - bound_region_2)
...
if __name__ == "__main__":
    ...
    fig.update_layout(
        scene=dict(
            xaxis_title="radius", yaxis_title="speed", zaxis_title="steering diff"
        )
    )
    ...
    fig.update_layout(
        scene=dict(xaxis_title="radius", yaxis_title="speed", zaxis_title="error")
    )
    fig.show()

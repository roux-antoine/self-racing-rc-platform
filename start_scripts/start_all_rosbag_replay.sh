...
session="self_racing_rc_platform-rosbag-replay"
...
tmux send-keys "rosrun localization_pkg map_publisher.py _map_file_name:=Map_Canada.kml" C-m

# waypoint publisher
tmux select-pane -t 1
tmux send-keys "cd '$ABS_SCRIPT_DIR/../autonomy_software/localization_pkg/src'" C-m
tmux send-keys "source $setup_bash_path" C-m
tmux send-keys "rosrun localization_pkg waypoints_publisher.py _waypoints_file:=canada_wp_straight_line_north_1_detail_3m.txt" C-m
